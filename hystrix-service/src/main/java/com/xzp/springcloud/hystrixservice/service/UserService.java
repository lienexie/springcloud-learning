package com.xzp.springcloud.hystrixservice.service;
...
import com.xzp.springcloud.hystrixservice.pojo.Result;
import com.xzp.springcloud.hystrixservice.pojo.User;
...
public class UserService {
    ...
    /**
     * 声明的参数需要包含controller的声明参数，服务降级方法
     *
     * @param id
     * @return
     */
    ...
    /**
     * 忽略某些异常降级，当id为1时调用会降级，当id为2时，就会忽略异常而不降级，直接抛错
     * @param id
     * @return
     */
